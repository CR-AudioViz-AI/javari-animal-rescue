...
const BASE = 'https://animal-rescue.craudiovizai.com'
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/rescue/directory`, lastModified: now, changeFrequency: 'weekly', priority: 0.7 },
    { url: `${BASE}/rescue/register`, lastModified: now, changeFrequency: 'weekly', priority: 0.7 },
